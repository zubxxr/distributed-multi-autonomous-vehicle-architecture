...
![AVP Node](https://img.shields.io/badge/AVP_Node-custom-black?logo=robotarchitecture)
![License](https://img.shields.io/badge/License-Apache%202.0-blue?logo=apache)

**DMV-AVP** extends the **DMAVA** to support **multiple vehicles operating in a shared simulation environment across different physical hosts**.  
